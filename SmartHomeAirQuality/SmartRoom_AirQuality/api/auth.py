...
import jwt
import fastAPI_models,schema,main
...
def check_username_password(user: fastAPI_models.UserAuthenticate):
    db_user_info: schema.UserDetails = main.get_user_by_username(username=user.username)
    db_pass = db_user_info.user_password.encode('utf8')
